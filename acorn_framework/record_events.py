...
_ntuples_configuration = {
    ...
    'exp': {
        'samples': [ autils.Flavntuple_list_VBFH125_gamgam_experimental, autils.Flavntuple_list_ggH125_gamgam_experimental ],
        'recorders': [ ntuple_recording.record_cmilke_reco_jets, ntuple_recording.record_cmilke_truth_jets ]
    },
    'data': None
}
...
def record_events(input_type, args):
    ...
    data_dump_file_name = 'data/output_'+file_infix+args.ntuple+reco_level+'_record_'+input_type+'.p'
...
def run():
    ...
    parser.add_argument( "--infix", required = False, default = None, type=str, help = "Modify the output record name",) 
